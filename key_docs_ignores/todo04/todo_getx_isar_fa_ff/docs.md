# Criando o projeto
flutter create --project-name=todo_getx_isar_fa_ff --org education.brintec --platforms android,web -a kotlin ./todo_getx_isar_fa_ff


# sha
catalunha@pop-os:~/myapp/todo_getx_isar_fa_ff$ keytool -list -v \
...
catalunha@pop-os:~/myapp/todo_getx_isar_fa_ff$ 
